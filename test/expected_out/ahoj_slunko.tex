...
\num
\chordson
\[F\hidx{maj7}]{Ahoj, slun}\[C]ko, \[H\hidx{dim}]{tobě to teda dneska} \[Am\hidx{7}]{sekne\qquad}\\
\[Dm\hidx{7}]{Včera mi bylo} \[G\hidx{7}]{smutno, ale} \[C]dneska už je \[C/H]{zase mírně} \[Am]pěkně\\
\[Dm\hidx{7}]{Jó, někdy se} \[G\hidx{7}]{zdá, že něco} \[C]nejde, ale \[C/H]{ono to pak} \[Am]{jde\qquad}\\
\[Dm\hidx{7}]{Doba, ta není} \[G\hidx{7}]{zlá, to jenom} \[F]některé \[G]vteřiny jsou \[C]zlé
\fin
\num
\chordson
\[C]Ahoj, a\[F]hoj, \[G]slun\[C]ko, jsem \[H\hidx{dim}]{rád, že jsi} \[Am\hidx{7}]{ještě\qquad}\\
\chordsoff
...
\cverse
\chordson
\[C]{A}\[F]hoj, a\[G]hoj, slun\[C]ko, a\[F]hoj, a\[G]hoj, slun\[C]{ko\qquad}\\
